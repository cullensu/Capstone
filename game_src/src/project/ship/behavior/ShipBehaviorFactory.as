package project.ship.behavior 
{
	...
	public class ShipBehaviorFactory 
	{
		...
		public function reinitTypes():void
		{
			...
			bossFastGun.gunCooldown = 1.0 - 0.25 * GameRegistry.gameState.miniBossManager.bossesDefeated;
			_bossFast.guns.push(bossFastGun);
			var bossFastGun2:OffsetGun = new OffsetGun();
			bossFastGun2.bulletType = BulletType.BIG_TRIANGLE;
			bossFastGun2.gunCooldown = 1.0 - 0.25 * GameRegistry.gameState.miniBossManager.bossesDefeated;
			...
			bossFastGun3.gunCooldown = 1.0 - 0.25 * GameRegistry.gameState.miniBossManager.bossesDefeated;
